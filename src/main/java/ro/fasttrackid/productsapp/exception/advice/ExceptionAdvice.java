package ro.fasttrackid.productsapp.exception.advice;
...
import ro.fasttrackid.productsapp.exception.custom.InvalidPersonException;
...
public class ExceptionAdvice {
    ...
    @ResponseStatus(BAD_REQUEST)
    ExceptionResponse handleResourceNotFound(InvalidEnumValueException ex) {
        return ExceptionResponse.builder()
                .internalCode("IEV01")
                .message(ex.getMessage())
                .build();
